...
public class InternalSiteWebCrawlerTest {
	...
	public void init(){
		...
		webCrawler= WebCrawlerFactory.getWebCrawlerInstance(WebCrawlerType.INTERNAL, crawlSite);
	}
	...
	public void crawl_wipro_internal_links(){
		...
		List<String> listOfURLs = XMLUtil.readXML(InternalSiteWebCrawler.OUTPUT_FILE_NAME);
