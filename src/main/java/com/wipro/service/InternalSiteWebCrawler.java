 ...
 *
 */
public class InternalSiteWebCrawler implements WebCrawler {
	private static Logger LOG = Logger.getLogger(InternalSiteWebCrawler.class.getCanonicalName()) ;
	...
	public InternalSiteWebCrawler(String url){
		this.ROOT_URL = url;
    ...
    private void crawlPage(String url) {
        ...
        try {
            ...
            doc = Jsoup.connect(url).userAgent(WebCrawler.APPLICATION_USER_AGENT).timeout(5000).get();
        } catch (IOException e) {
        ...
        for (Element link : links) {
            ...
            if (linkUrl.startsWith(ROOT_URL)) { 
                ...
                if (!linkUrl.matches(NOT_A_PAGE)) { 
                    ...
                    // if we are here this is a valid internal url, crawl it recursively
